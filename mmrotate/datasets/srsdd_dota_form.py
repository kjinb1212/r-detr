...
class SRSDD_DOTA_form_Dataset(CustomDataset):
    ...
    def __init__(self,
        ...
        super(SRSDD_DOTA_form_Dataset, self).__init__(ann_file, pipeline, **kwargs)

    def __len__(self):
        """Total number of samples of data."""
        return len(self.data_infos)

    def load_annotations(self, ann_folder, ext='.png'):
        """
            Args:
