    ...
    hooks=[
        ...
        dict(type='MMDetWandbHook',
         init_kwargs={
             ...
             'entity': 'kjinb1212', 
             'name':'ssdd_dota_pretrained_1024',
            #  'id': 'ssdd_dota_pretrained',
...
work_dir='/media/data1/jinbeom/sar_datasets/swint10_ssdd_dota_pretrained_1024'
